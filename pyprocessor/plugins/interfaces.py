...
class EncoderPlugin(Plugin):
    ...
    def encode(self, input_file: str, output_file: str, options: Dict[str, Any] = None) -> bool:
        """
        Encode a file.
    ...
    def get_supported_formats(self) -> List[str]:
        ...
        """
        raise NotImplementedError("Encoder plugins must implement get_supported_formats method")
    ...
    def get_supported_codecs(self) -> Dict[str, List[str]]:
        ...
        """
        raise NotImplementedError("Encoder plugins must implement get_supported_codecs method")
    ...
    def get_default_options(self) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Encoder plugins must implement get_default_options method")
...
class ProcessorPlugin(Plugin):
    ...
    def process(self, input_file: str, output_file: str, options: Dict[str, Any] = None) -> bool:
        """
        Process a file.
    ...
    def get_supported_formats(self) -> List[str]:
        ...
        Returns:
            List[str]: List of supported formats (e.g., ["mp4", "mkv"])
        """
        raise NotImplementedError("Processor plugins must implement get_supported_formats method")
    ...
    def get_default_options(self) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Processor plugins must implement get_default_options method")
...
class FilterPlugin(Plugin):
    ...
    def apply_filter(self, input_file: str, output_file: str, options: Dict[str, Any] = None) -> bool:
        """
    ...
    def get_supported_formats(self) -> List[str]:
        ...
        Returns:
            List[str]: List of supported formats (e.g., ["mp4", "mkv"])
        """
        raise NotImplementedError("Filter plugins must implement get_supported_formats method")
    ...
    def get_default_options(self) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Filter plugins must implement get_default_options method")
...
class AnalyzerPlugin(Plugin):
    ...
    def analyze(self, input_file: str, options: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Analyze a file.
    ...
    def get_supported_formats(self) -> List[str]:
        ...
        Returns:
            List[str]: List of supported formats (e.g., ["mp4", "mkv"])
        """
        raise NotImplementedError("Analyzer plugins must implement get_supported_formats method")
    ...
    def get_default_options(self) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Analyzer plugins must implement get_default_options method")
...
class OutputPlugin(Plugin):
    ...
    def get_supported_formats(self) -> List[str]:
        ...
        Returns:
            List[str]: List of supported formats (e.g., ["mp4", "mkv"])
        """
        raise NotImplementedError("Output plugins must implement get_supported_formats method")
    ...
    def get_default_options(self) -> Dict[str, Any]:
        ...
        """
        raise NotImplementedError("Output plugins must implement get_default_options method")
