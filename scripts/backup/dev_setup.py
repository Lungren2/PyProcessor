#!/usr/bin/env python3
"""
Cross-platform development environment setup script for PyProcessor.
...
Usage:
    python scripts/dev_setup.py [--no-venv] [--no-ffmpeg] [--no-hooks] [--platform PLATFORM]
...
def install_dependencies(pip_path, target_platform=None):
    ...
    try:
        ...
        print("✓ Installed package in development mode with dev extras")
