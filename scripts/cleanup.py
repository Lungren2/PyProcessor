...
def remove_pycache():
    ...
    print(
        f"✓ Removed {len(pycache_dirs)} __pycache__ directories and {len(pyc_files)} .pyc files"
    )
    return True
...
def remove_ffmpeg_temp():
    ...
    print(
        f"✓ Removed {removed_files} FFmpeg files and {removed_dirs} FFmpeg directories"
    )
    return True
